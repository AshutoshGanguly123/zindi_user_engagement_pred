...
def main():
    ...
    print("="*60)
    print("DECISION TREE MODEL FOR USER ENGAGEMENT PREDICTION")
    print("="*60)
    ...
    # Train model
    model, y_train_pred, y_test_pred, y_train_proba, y_test_proba = train_decision_tree(
    ...
    print(f"\nModel saved to: ../data/decision_tree_model.pkl")
...
def save_results_to_file(train_metrics, test_metrics, feature_importance_data, 
    ...
    output_file = "../data/decision_tree_results.txt"
    
    with open(output_file, 'w') as f:
        f.write("="*80 + "\n")
        f.write("DECISION TREE MODEL RESULTS FOR USER ENGAGEMENT PREDICTION\n")
        f.write("="*80 + "\n\n")
        ...
        f.write("-" * 40 + "\n")
        f.write("Model Type: Decision Tree Classifier\n")
        f.write("Key Parameters:\n")
        f.write("  - max_depth: 10\n")
        f.write("  - min_samples_split: 20\n")
        f.write("  - min_samples_leaf: 10\n")
        ...
        f.write(f"  - Model shows {'good' if test_metrics['auc'] > 0.8 else 'moderate'} discriminative ability\n")
